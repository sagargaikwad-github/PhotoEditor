...
public class TextColorAdapter extends RecyclerView.Adapter<TextColorAdapter.holder> {
    ...
    public TextColorAdapter(ArrayList<Integer> arrayList, Context context, BottomSheetDialog bottomSheetDialog, BrushColor brushColor) {
    ...
    public void onBindViewHolder(@NonNull holder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AddPhoto addPhoto= (AddPhoto) context;
                addPhoto.enterTextBS.setTextColor(ContextCompat.getColor(context,arrayList.get(position)));
